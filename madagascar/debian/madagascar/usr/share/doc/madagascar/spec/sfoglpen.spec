[sfoglpen]
Cat:    RSF/pens/main
Desc:   vplot filter for OpenGL
DocCmd: sfoglpen | cat
Param:  aalias enum-bool  -  n 		y - draw lines, points, polygons with antialialing 
Param:  aawidth int  -  1 		width of transition areas when aalias=y 
...
Param:  size string  -   -  		
Param:  stretchy enum-bool  -  n 		y - stretch plot to all borders of the drawing area 
Param:  style string  -   -  		
Param:  txfont int  -   -  		
Param:  txovly int  -   -  		
Param:  txprec int  -   -  		
