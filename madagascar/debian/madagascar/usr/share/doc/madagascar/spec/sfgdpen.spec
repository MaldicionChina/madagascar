[sfgdpen]
Cat:    RSF/pens/main
Desc:   vplot filter for LibGD
DocCmd: sfgdpen | cat
Param:  aspect float  -   -  		aspect ratio 
Param:  background enum-bool  -   -  		
Param:  bgcolor string  -   -  		background color (black,white,light,dark) 
LDesc:         'light' and 'dark' cause the background to be transparent (in PNG and GIF) 
Param:  bitrate int  -  400000 		MPEG bitrate 
...
Param:  delay int  -  10 		animation delay (if type=='gif' or 'mpeg') 
...
Param:  greyc float  -   -  		'grey correction' modifies the grey scale used to display a raster to simulate the nonlinearity of displays, see 'man vplotraster' 
Param:  interact string  -   -  		
Param:  invras enum-bool  -   -  		
Param:  mkscale float  -  1.0 		
Param:  mono enum-bool  -  n 		no color 
Param:  n1 int  -   -  		
Param:  n2 int  -   -  		image size 
Param:  overlay enum-bool  -   -  		
Param:  patternmult float  -  1. 		
Param:  pause int  -  0 		
Param:  pixc float  -   -  		'pixel  correction' controls  alteration of the grey scale, see 'man vplotraster'. 
...
Param:  type string  -   -  		image type (png, jpeg, gif, mpeg) 
