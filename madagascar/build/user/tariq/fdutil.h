...
typedef struct abc2s *abcone2ds;
...
/*------------------------------------------------------------*/
fdm2ds fdutil2ds_init(bool verb_, 
		    bool free_,
		    sf_axis az_, 
		    sf_axis ax_, 
		    sf_axis ay_, 
...
/*------------------------------------------------------------*/
abcone2ds abcone2ds_make(int     nop,
		       float    dt,
		       float **vv,
		       bool   free, 
		       fdm2ds   fdm);
